...
struct ChainLengthAndBagStripeIndex(u16);
...
impl ChainLengthAndBagStripeIndex
{
	...
	#[inline(always)]
	fn new(chain_length: ChainLength, bag_stripe_index: Option<BagStripeIndex>) -> Self
	{
	...
	#[inline(always)]
	fn bag_stripe_index(self) -> Option<BagStripeIndex>
	{
