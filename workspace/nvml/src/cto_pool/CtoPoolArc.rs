...
//	}
	...
	#[inline(always)]
	fn free_pointer<T>(&self, non_null_pointer: *mut T)
	{
		debug_assert!(non_null_pointer.is_not_null(), "non_null_pointer was null");
		
		self.pool_pointer().free(non_null_pointer)
	}
