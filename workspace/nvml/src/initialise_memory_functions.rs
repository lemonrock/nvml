...
/// }
///
/// initialise_memory_functions!(dpdkMalloc, dpdkRealloc ::dpdk_sys::rte_free);
/// ```
#[macro_export]
macro_rules! initialise_memory_functions
{
	...
	{
		{
			...
			#[inline(always)]
			fn initialise_memory_functions
			(
			...
			{
				$crate::blockPool::initialise_memory_functions(malloc, free, realloc, strdup);
				$crate::logPool::initialise_memory_functions(malloc, free, realloc, strdup);
				$crate::transactionalObjectPool::initialise_memory_functions(malloc, free, realloc, strdup);
			}
			
			initialise_memory_functions($malloc, $free, $realloc, strdup)
		}
	}
}
